...
from myTransformers.utils import check_min_version, is_offline_mode, send_example_telemetry
...
def parse_args():
    parser = argparse.ArgumentParser(description="Finetune a myTransformers model on a summarization task")
    parser.add_argument(
        "--dataset_name",
        type=str,
        default=None,
