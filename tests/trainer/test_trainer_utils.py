...
from myTransformers.data.data_collator import default_data_collator
from myTransformers.testing_utils import require_accelerate, require_torch
from myTransformers.trainer_utils import RemoveColumnsCollator, find_executable_batch_size
...
if is_torch_available():
    ...
    from myTransformers.modeling_outputs import SequenceClassifierOutput
    from myTransformers.tokenization_utils_base import BatchEncoding
    from myTransformers.trainer_pt_utils import (
