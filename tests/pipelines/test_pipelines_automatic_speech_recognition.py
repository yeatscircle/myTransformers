...
from myTransformers.pipelines import AutomaticSpeechRecognitionPipeline, pipeline
from myTransformers.pipelines.audio_utils import chunk_bytes_iter, ffmpeg_microphone_live
from myTransformers.pipelines.automatic_speech_recognition import _find_timestamp_sequence, chunk_iter
...
class AutomaticSpeechRecognitionPipelineTests(unittest.TestCase):
    ...
    def test_slow_unfinished_sequence(self):
        from myTransformers import GenerationConfig
