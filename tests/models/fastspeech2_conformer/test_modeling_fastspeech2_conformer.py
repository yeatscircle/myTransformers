...
from myTransformers.testing_utils import require_g2p_en, require_torch, require_torch_accelerator, slow, torch_device
...
if is_torch_available():
    ...
    from myTransformers import FastSpeech2ConformerModel, FastSpeech2ConformerWithHifiGan, set_seed
