...
from myTransformers import EfficientNetConfig
from myTransformers.testing_utils import is_pipeline_test, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from myTransformers import EfficientNetForImageClassification, EfficientNetModel
