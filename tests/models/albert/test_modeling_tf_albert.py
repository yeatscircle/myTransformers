...
from myTransformers import AlbertConfig, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers import TF_MODEL_FOR_PRETRAINING_MAPPING
    from myTransformers.models.albert.modeling_tf_albert import (
        TFAlbertForMaskedLM,
