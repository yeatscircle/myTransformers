...
from myTransformers import ConditionalDetrConfig, ResNetConfig, is_torch_available, is_vision_available
...
if is_vision_available():
    ...
    from myTransformers import ConditionalDetrImageProcessor
