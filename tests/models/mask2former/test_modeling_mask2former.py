...
from myTransformers import Mask2FormerConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from myTransformers import Mask2FormerForUniversalSegmentation, Mask2FormerModel
