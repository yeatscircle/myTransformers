...
from myTransformers import MobileNetV2Config
...
if is_torch_available():
    ...
    from myTransformers import MobileNetV2ForImageClassification, MobileNetV2ForSemanticSegmentation, MobileNetV2Model


if is_vision_available():
    from PIL import Image

    from myTransformers import MobileNetV2ImageProcessor
