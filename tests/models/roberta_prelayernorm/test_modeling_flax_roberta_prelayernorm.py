...
from myTransformers import RobertaPreLayerNormConfig, is_flax_available
...
if is_flax_available():
    ...
    from myTransformers.models.roberta_prelayernorm.modeling_flax_roberta_prelayernorm import (
