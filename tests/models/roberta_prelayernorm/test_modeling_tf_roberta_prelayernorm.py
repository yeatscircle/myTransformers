...
from myTransformers import RobertaPreLayerNormConfig, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers.models.roberta_prelayernorm.modeling_tf_roberta_prelayernorm import (
