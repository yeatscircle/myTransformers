...
from myTransformers import BloomConfig, is_torch_available
...
class BloomEmbeddingTest(unittest.TestCase):
    ...
    using Megatron-LM with the one from the myTransformers library, with a small GPT2-like model
    to ensure that the conversion from Megatron-LM to myTransformers has been done successfully.
