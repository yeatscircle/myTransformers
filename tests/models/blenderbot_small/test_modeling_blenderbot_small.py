...
from myTransformers import BlenderbotSmallConfig, is_torch_available
...
if is_torch_available():
    ...
    from myTransformers import BlenderbotSmallForConditionalGeneration, BlenderbotSmallModel, BlenderbotSmallTokenizer
    from myTransformers.models.blenderbot_small.modeling_blenderbot_small import (
