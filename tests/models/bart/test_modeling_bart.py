...
from myTransformers import BartConfig, is_torch_available
...
if is_torch_available():
    ...
    from myTransformers.models.bart.modeling_bart import BartDecoder, BartEncoder, shift_tokens_right
