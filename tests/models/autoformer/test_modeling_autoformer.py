...
from myTransformers.testing_utils import is_flaky, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from myTransformers import AutoformerConfig, AutoformerForPrediction, AutoformerModel
    from myTransformers.models.autoformer.modeling_autoformer import AutoformerDecoder, AutoformerEncoder
