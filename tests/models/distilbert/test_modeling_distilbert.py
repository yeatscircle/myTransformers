...
from myTransformers import DistilBertConfig, is_torch_available
from myTransformers.testing_utils import require_flash_attn, require_torch, require_torch_accelerator, slow, torch_device
...
if is_torch_available():
    ...
    from myTransformers.models.distilbert.modeling_distilbert import _create_sinusoidal_embeddings
