...
from myTransformers import VitPoseBackboneConfig, VitPoseConfig
...
if is_torch_available():
    ...
    from myTransformers import VitPoseForPoseEstimation


if is_vision_available():
    from PIL import Image

    from myTransformers import VitPoseImageProcessor
