...
from myTransformers import MobileNetV1Config
...
if is_torch_available():
    ...
    from myTransformers import MobileNetV1ForImageClassification, MobileNetV1Model


if is_vision_available():
    from PIL import Image

    from myTransformers import MobileNetV1ImageProcessor
