...
from myTransformers import OwlViTConfig, OwlViTTextConfig, OwlViTVisionConfig
...
if is_torch_available():
    ...
    from myTransformers import OwlViTForObjectDetection, OwlViTModel, OwlViTTextModel, OwlViTVisionModel


if is_vision_available():
    from PIL import Image

    from myTransformers import OwlViTProcessor
