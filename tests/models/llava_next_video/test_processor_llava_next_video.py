...
from myTransformers import AutoProcessor, LlamaTokenizerFast, LlavaNextVideoProcessor
...
if is_vision_available():
    from myTransformers import LlavaNextImageProcessor, LlavaNextVideoImageProcessor
