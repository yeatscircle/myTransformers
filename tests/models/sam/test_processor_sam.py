...
from myTransformers.utils import is_tf_available, is_torch_available, is_vision_available
...
if is_vision_available():
    ...
    from myTransformers import AutoProcessor, SamImageProcessor, SamProcessor

if is_torch_available():
    import torch

    from myTransformers.models.sam.image_processing_sam import _mask_to_rle_pytorch

if is_tf_available():
    import tensorflow as tf

    from myTransformers.models.sam.image_processing_sam import _mask_to_rle_tf
