...
from myTransformers import AutoTokenizer, GPTJConfig, is_tf_available
from myTransformers.testing_utils import require_tf, slow, tooslow
...
if is_tf_available():
    ...
    from myTransformers.models.gptj.modeling_tf_gptj import (
        TFGPTJForCausalLM,
