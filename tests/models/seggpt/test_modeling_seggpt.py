...
from myTransformers import SegGptConfig
...
if is_torch_available():
    ...
    from myTransformers import SegGptForImageSegmentation, SegGptModel
    from myTransformers.models.seggpt.modeling_seggpt import SegGptLoss


if is_vision_available():
    from myTransformers import SegGptImageProcessor
