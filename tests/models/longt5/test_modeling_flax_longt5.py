...
if is_flax_available():
    ...
    from myTransformers import FLAX_MODEL_FOR_QUESTION_ANSWERING_MAPPING, FLAX_MODEL_MAPPING, AutoTokenizer, LongT5Config
    from myTransformers.models.longt5.modeling_flax_longt5 import (
