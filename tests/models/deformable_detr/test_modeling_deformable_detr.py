...
from myTransformers import DeformableDetrConfig, ResNetConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from myTransformers import DeformableDetrForObjectDetection, DeformableDetrModel
