...
from myTransformers.testing_utils import require_torch, require_torch_gpu, require_vision, slow
...
if is_vision_available():
    ...
    from myTransformers import DeformableDetrImageProcessor, DeformableDetrImageProcessorFast
