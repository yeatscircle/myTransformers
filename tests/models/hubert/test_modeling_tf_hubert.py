...
from myTransformers.testing_utils import require_soundfile, require_tf, slow
...
if is_tf_available():
    ...
    from myTransformers import HubertConfig, TFHubertForCTC, TFHubertModel, Wav2Vec2Processor
    from myTransformers.models.hubert.modeling_tf_hubert import _compute_mask_indices
