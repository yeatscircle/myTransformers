...
if is_torch_available():
    ...
    from myTransformers.models.superpoint.modeling_superpoint import SuperPointKeypointDescriptionOutput

if is_vision_available():
    from myTransformers import SuperPointImageProcessor
