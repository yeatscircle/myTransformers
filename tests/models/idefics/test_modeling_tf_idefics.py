...
from myTransformers import IdeficsConfig, is_tf_available, is_vision_available
from myTransformers.testing_utils import TestCasePlus, require_tf, require_vision, slow
...
if is_tf_available():
    ...
    from myTransformers import IdeficsProcessor, TFIdeficsForVisionText2Text, TFIdeficsModel
