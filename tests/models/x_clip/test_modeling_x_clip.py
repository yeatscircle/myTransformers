...
from myTransformers import XCLIPConfig, XCLIPTextConfig, XCLIPVisionConfig
...
if is_torch_available():
    ...
    from myTransformers import XCLIPModel, XCLIPTextModel, XCLIPVisionModel


if is_vision_available():
    from myTransformers import XCLIPProcessor
