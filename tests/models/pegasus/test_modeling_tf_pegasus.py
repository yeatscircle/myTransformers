...
from myTransformers import AutoTokenizer, PegasusConfig, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers import TFAutoModelForSeq2SeqLM, TFPegasusForConditionalGeneration, TFPegasusModel
