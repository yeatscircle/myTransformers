...
from myTransformers import DetrConfig, MaskFormerConfig, SwinConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from myTransformers import MaskFormerForInstanceSegmentation, MaskFormerModel
