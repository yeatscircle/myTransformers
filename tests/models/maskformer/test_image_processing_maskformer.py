...
if is_torch_available():
    ...
    if is_vision_available():
        from myTransformers import MaskFormerImageProcessor
        from myTransformers.models.maskformer.image_processing_maskformer import binary_mask_to_rle
        from myTransformers.models.maskformer.modeling_maskformer import MaskFormerForInstanceSegmentationOutput
