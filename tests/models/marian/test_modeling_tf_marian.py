...
from myTransformers import AutoTokenizer, MarianConfig, MarianTokenizer, TranslationPipeline, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers import TFAutoModelForSeq2SeqLM, TFMarianModel, TFMarianMTModel
