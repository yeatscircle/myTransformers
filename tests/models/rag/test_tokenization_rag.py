...
from myTransformers import BartTokenizer, BartTokenizerFast, DPRQuestionEncoderTokenizer, DPRQuestionEncoderTokenizerFast
...
from myTransformers.testing_utils import require_faiss, require_tokenizers, require_torch, slow
from myTransformers.utils import is_datasets_available, is_faiss_available, is_torch_available


if is_torch_available() and is_datasets_available() and is_faiss_available():
    from myTransformers.models.rag.configuration_rag import RagConfig
    from myTransformers.models.rag.tokenization_rag import RagTokenizer
