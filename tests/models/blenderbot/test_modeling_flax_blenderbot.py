...
from myTransformers import BlenderbotConfig, is_flax_available
from myTransformers.testing_utils import jax_device, require_flax, slow
...
if is_flax_available():
    ...
    from myTransformers.models.blenderbot.modeling_flax_blenderbot import (
