...
from myTransformers import ConvNextConfig
...
if is_tf_available():
    ...
    from myTransformers import TFConvNextForImageClassification, TFConvNextModel


if is_vision_available():
    from PIL import Image

    from myTransformers import ConvNextImageProcessor
