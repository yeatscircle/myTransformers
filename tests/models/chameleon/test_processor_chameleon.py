...
from myTransformers import ChameleonProcessor, LlamaTokenizer
from myTransformers.testing_utils import get_tests_dir
...
if is_vision_available():
    from myTransformers import ChameleonImageProcessor
