...
from myTransformers import SPIECE_UNDERLINE, BatchEncoding, PLBartTokenizer, is_torch_available
...
if is_torch_available():
    from myTransformers.models.plbart.modeling_plbart import shift_tokens_right
