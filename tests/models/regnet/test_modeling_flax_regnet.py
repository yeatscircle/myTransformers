...
from myTransformers import RegNetConfig, is_flax_available
...
if is_flax_available():
    ...
    from myTransformers.models.regnet.modeling_flax_regnet import FlaxRegNetForImageClassification, FlaxRegNetModel
