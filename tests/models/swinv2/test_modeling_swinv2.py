...
from myTransformers import Swinv2Config
...
if is_torch_available():
    ...
    from myTransformers import Swinv2Backbone, Swinv2ForImageClassification, Swinv2ForMaskedImageModeling, Swinv2Model
