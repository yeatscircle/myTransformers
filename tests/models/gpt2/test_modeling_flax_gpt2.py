...
from myTransformers import GPT2Config, GPT2Tokenizer, is_flax_available
...
if is_flax_available():
    ...
    from myTransformers.models.gpt2.modeling_flax_gpt2 import FlaxGPT2LMHeadModel, FlaxGPT2Model
