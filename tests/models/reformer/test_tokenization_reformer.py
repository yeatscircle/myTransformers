...
from myTransformers import SPIECE_UNDERLINE, ReformerTokenizer, ReformerTokenizerFast
from myTransformers.testing_utils import get_tests_dir, require_sentencepiece, require_tokenizers, require_torch, slow
...
class ReformerTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_torch_encode_plus_sent_to_model(self):
        ...
        from myTransformers import ReformerConfig, ReformerModel
