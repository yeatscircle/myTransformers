...
if is_torch_available():
    ...
    if is_vision_available():
        from myTransformers import OneFormerImageProcessor
        from myTransformers.models.oneformer.image_processing_oneformer import binary_mask_to_rle, prepare_metadata
