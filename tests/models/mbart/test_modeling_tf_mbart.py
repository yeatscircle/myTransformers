...
from myTransformers import AutoTokenizer, MBartConfig, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers import TFAutoModelForSeq2SeqLM, TFMBartForConditionalGeneration, TFMBartModel
