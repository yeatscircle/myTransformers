...
from myTransformers import LxmertConfig, is_tf_available
...
if is_tf_available():
    ...
    from myTransformers.models.lxmert.modeling_tf_lxmert import TFLxmertForPreTraining, TFLxmertModel
