...
from myTransformers.file_utils import cached_property, is_tf_available, is_vision_available
...
if is_tf_available():
    ...
    from myTransformers import TFViTMAEForPreTraining, TFViTMAEModel
