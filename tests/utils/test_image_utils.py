...
from myTransformers import is_torch_available, is_vision_available
from myTransformers.image_utils import (
    ChannelDimension,
...
from myTransformers.testing_utils import is_flaky, require_torch, require_vision
...
if is_vision_available():
    ...
    from myTransformers import ImageFeatureExtractionMixin
    from myTransformers.image_utils import get_image_size, infer_channel_dimension_format, load_image
