...
from myTransformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, GenerationConfig, QuarkConfig
...
from myTransformers.utils.import_utils import is_quark_available
