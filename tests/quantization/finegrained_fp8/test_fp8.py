...
from myTransformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, FineGrainedFP8Config, OPTForCausalLM
...
class FP8QuantizerTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        from myTransformers.integrations import FP8Linear, replace_with_fp8_linear
...
class FP8LinearTest(unittest.TestCase):
    ...
    def test_linear_preserves_shape(self):
        ...
        """
        from myTransformers.integrations import FP8Linear
