...
from myTransformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, HiggsConfig, OPTForCausalLM
...
class HiggsTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        from myTransformers.integrations import HiggsLinear, replace_with_higgs_linear
