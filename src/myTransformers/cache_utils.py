...
from myTransformers.pytorch_utils import is_torch_greater_or_equal_than_2_6
...
class CacheConfig:
    ...
    # Copied from myTransformers.utils.quantization_config.QuantizationConfigMixin.to_json_file
    ...
    # Copied from myTransformers.utils.quantization_config.QuantizationConfigMixin.to_dict
    ...
    # Copied from myTransformers.utils.quantization_config.QuantizationConfigMixin.__iter__
    def __iter__(self):
        """allows `dict(obj)` for situations where obj may be a dict or QuantizationConfigMixin"""
        for attr, value in copy.deepcopy(self.__dict__).items():
            yield attr, value

    # Copied from myTransformers.utils.quantization_config.QuantizationConfigMixin.__repr__
    def __repr__(self):
    ...
    # Copied from myTransformers.utils.quantization_config.QuantizationConfigMixin.update
...
class SlidingWindowCache(StaticCache):
    ...
    Example:
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, AutoModelForCausalLM, SlidingWindowCache
...
class EncoderDecoderCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from myTransformers import AutoProcessor, AutoModelForCausalLM, DynamicCache, EncoderDecoderCache
...
class MambaCache:
    ...
    Example:
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, MambaForCausalLM, MambaCache
...
class OffloadedStaticCache(StaticCache):
    ...
    Example:
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, AutoModelForCausalLM, OffloadedStaticCache
