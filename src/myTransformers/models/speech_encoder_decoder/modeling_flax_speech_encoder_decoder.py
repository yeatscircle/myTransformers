...
class FlaxSpeechEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    as decoder module when created with the :meth*~myTransformers.FlaxAutoModel.from_pretrained* class method for the
    ...
    def encode(
        ...
        ```python
        >>> from myTransformers import FlaxSpeechEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from myTransformers import FlaxSpeechEncoderDecoderModel, AutoTokenizer
