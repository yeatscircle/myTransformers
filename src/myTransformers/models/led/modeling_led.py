...
# Copied from myTransformers.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from myTransformers.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from myTransformers import AutoTokenizer, LEDForConditionalGeneration
...
class LEDForSequenceClassification(LEDPreTrainedModel):
    ...
    def __init__(self, config: LEDConfig, **kwargs):
        warnings.warn(
            "The `myTransformers.LEDForSequenceClassification` class is deprecated and will be removed in version 5 of"
