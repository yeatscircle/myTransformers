...
# Copied from myTransformers.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from myTransformers.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
