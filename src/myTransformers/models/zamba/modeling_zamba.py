...
# Copied from myTransformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->Zamba
...
class ZambaHybridDynamicCache(DynamicCache):
    ...
    # Copied from myTransformers.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.update
    def update(
        self,
    ...
    # Copied from myTransformers.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.reorder_cache
    ...
    # Copied from myTransformers.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.get_seq_length
...
class ZambaAttention(nn.Module):
    ...
    Adapted from myTransformers.models.mistral.modeling_mistral.MistralAttention:
...
class ZambaMambaMixer(nn.Module):
    ...
    This module differs from `myTransformers.models.mamba.modeling_mamba.MambaMixer` in two ways:
...
# Copied from myTransformers.models.mistral.modeling_mistral.MistralMLP with Mistral->Zamba
...
class ZambaModel(ZambaPreTrainedModel):
    ...
    # Copied from myTransformers.models.jamba.modeling_jamba.JambaModel._update_causal_mask
...
# Adapted from myTransformers.models.jamba.modeling_jamba.JambaForCausalLM with Jamba->Zamba, JAMBA->ZAMBA
class ZambaForCausalLM(ZambaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ZambaForCausalLM
