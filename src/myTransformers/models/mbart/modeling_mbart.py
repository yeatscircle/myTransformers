...
# Copied from myTransformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartFlashAttention2 with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartSdpaAttention with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, MBartForConditionalGeneration
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartForCausalLM with Bart->MBart, facebook/bart-base->facebook/mbart-large-cc25
class MBartForCausalLM(MBartPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, MBartForCausalLM
