...
class GraniteSpeechEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import GraniteSpeechEncoderConfig, GraniteSpeechCTCEncoder
...
class GraniteSpeechConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import GraniteSpeechConfig, GraniteSpeechForConditionalGeneration
