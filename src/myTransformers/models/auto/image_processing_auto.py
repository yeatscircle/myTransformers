...
if TYPE_CHECKING:
    ...
    # the myTransformers package is used with Microsoft's Pylance language server.
...
def get_image_processor_class_from_name(class_name: str):
    ...
    for module_name, extractors in IMAGE_PROCESSOR_MAPPING_NAMES.items():
        if class_name in extractors:
            ...
            module = importlib.import_module(f".{module_name}", "myTransformers.models")
            try:
    ...
    main_module = importlib.import_module("myTransformers")
...
class AutoImageProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        try:
            # Main path for all myTransformers models and local TimmWrapper checkpoints
