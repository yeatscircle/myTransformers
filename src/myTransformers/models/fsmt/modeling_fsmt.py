...
# - beam search: stops as soon as num_beams == len(hypos) (whereas myTransformers
#   is not satisfied there and will continue searching until the next cycles
#   aren't promising something better), comparing BLEU scores - the myTransformers
...
FSMT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, FSMTForConditionalGeneration
