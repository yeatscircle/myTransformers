...
class UdopProcessor(ProcessorMixin):
    ...
    # Copied from myTransformers.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.get_overflowing_images
    ...
    # Copied from myTransformers.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.batch_decode
    ...
    # Copied from myTransformers.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.decode
