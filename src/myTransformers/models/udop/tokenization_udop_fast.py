...
class UdopTokenizerFast(PreTrainedTokenizerFast):
    ...
    # Copied from myTransformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.tokenize
    ...
    # Copied from myTransformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast._pad
    def _pad(
        self,
    ...
    # Copied from myTransformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.save_vocabulary
