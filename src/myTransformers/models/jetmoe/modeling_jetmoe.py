...
# Copied from myTransformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->JetMoe
...
# Copied from myTransformers.models.gemma.modeling_gemma.GemmaRotaryEmbedding with Gemma->JetMoe
...
class JetMoeModel(JetMoePreTrainedModel):
    ...
    # Copied from myTransformers.models.llama.modeling_llama.LlamaModel.get_input_embeddings
    def get_input_embeddings(self):
        return self.embed_tokens

    # Copied from myTransformers.models.llama.modeling_llama.LlamaModel.set_input_embeddings
...
# Copied from myTransformers.models.llama.modeling_llama.LlamaForSequenceClassification with Llama->JetMoe, LLAMA->JETMOE, BaseModelOutputWithPast->MoeModelOutputWithPast
