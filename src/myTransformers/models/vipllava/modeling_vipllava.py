...
@dataclass
# Copied from myTransformers.models.llava.modeling_llava.LlavaCausalLMOutputWithPast with Llava->VipLlava
...
# Copied from myTransformers.models.llava.modeling_llava.LlavaForConditionalGeneration with LLAVA->VIPLLAVA,Llava->VipLlava
class VipLlavaForConditionalGeneration(VipLlavaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, VipLlavaForConditionalGeneration
