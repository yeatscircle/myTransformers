...
class FastSpeech2ConformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import FastSpeech2ConformerModel, FastSpeech2ConformerConfig
...
class FastSpeech2ConformerHifiGanConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import FastSpeech2ConformerHifiGan, FastSpeech2ConformerHifiGanConfig
