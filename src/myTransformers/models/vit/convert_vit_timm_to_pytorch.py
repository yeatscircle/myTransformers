...
from myTransformers import DeiTImageProcessor, ViTConfig, ViTForImageClassification, ViTImageProcessor, ViTModel
...
def convert_vit_checkpoint(vit_name, pytorch_dump_folder_path):
    ...
    # detect unsupported ViT models in myTransformers
    # fc_norm is present
