...
# Copied from myTransformers.models.clip.modeling_clip.clip_loss with clip->clvp, image_loss->speech_loss
...
# Copied from myTransformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->Clvp
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->Clvp
...
# Copied from myTransformers.models.gpt2.modeling_gpt2.GPT2MLP with GPT2->ClvpDecoderMLP
...
class ClvpModelForConditionalGeneration(ClvpPreTrainedModel, GenerationMixin):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import ClvpProcessor, ClvpModelForConditionalGeneration
