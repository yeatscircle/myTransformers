...
class ClvpTokenizer(PreTrainedTokenizer):
    ...
    # Copied from myTransformers.models.llama.tokenization_llama.LlamaTokenizer.build_inputs_with_special_tokens
    ...
    # Copied from myTransformers.models.gpt2.tokenization_gpt2.GPT2Tokenizer.get_special_tokens_mask
