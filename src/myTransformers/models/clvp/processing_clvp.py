...
class ClvpProcessor(ProcessorMixin):
    ...
    # Copied from myTransformers.models.whisper.processing_whisper.WhisperProcessor.batch_decode with Whisper->Clvp
    ...
    # Copied from myTransformers.models.whisper.processing_whisper.WhisperProcessor.decode with Whisper->Clvp
