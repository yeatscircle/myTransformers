...
class TimmWrapperModel(TimmWrapperPreTrainedModel):
    """
    Wrapper class for timm models to be used in myTransformers.
    """
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> from myTransformers import AutoModel, AutoImageProcessor
...
class TimmWrapperForImageClassification(TimmWrapperPreTrainedModel):
    """
    Wrapper class for timm models to be used in myTransformers for image classification.
    """
