...
# Copied from myTransformers.models.clip.modeling_clip.clip_loss with clip->x_clip
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->XCLIP
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->XCLIP
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->XCLIP
...
# Copied from myTransformers.models.beit.modeling_beit.BeitDropPath with Beit->XCLIP
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->XCLIP
...
class XCLIPTextModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XCLIPTextModel
...
class XCLIPVisionModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> from myTransformers import AutoProcessor, XCLIPVisionModel
