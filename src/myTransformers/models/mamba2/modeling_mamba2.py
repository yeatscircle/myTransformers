...
@dataclass
# Copied from myTransformers.models.mamba.modeling_mamba.MambaOutput with MAMBA->MAMBA2,Mamba->Mamba2
...
@dataclass
# Copied from myTransformers.models.mamba.modeling_mamba.MambaCausalLMOutput with Mamba->Mamba2
