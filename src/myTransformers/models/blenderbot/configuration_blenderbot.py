...
class BlenderbotConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BlenderbotConfig, BlenderbotModel
...
class BlenderbotOnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    @property
    # Copied from myTransformers.models.bart.configuration_bart.BartOnnxConfig.outputs
    ...
    # Copied from myTransformers.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_sequence_classification_and_question_answering
    ...
    # Copied from myTransformers.models.bart.configuration_bart.BartOnnxConfig.generate_dummy_inputs
    ...
    # Copied from myTransformers.models.bart.configuration_bart.BartOnnxConfig._flatten_past_key_values_
