...
class UniSpeechSatForPreTraining(UniSpeechSatPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoFeatureExtractor, UniSpeechSatForPreTraining
        >>> from myTransformers.models.unispeech_sat.modeling_unispeech_sat import _compute_mask_indices
