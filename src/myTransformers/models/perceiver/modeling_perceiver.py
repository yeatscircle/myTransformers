...
PERCEIVER_MODEL_START_DOCSTRING = r"""
    ...
    Parameters:
        ...
        decoder (*DecoderType*, *optional*):
            ...
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverBasicDecoder*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverClassificationDecoder*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverMultimodalDecoder*.
        input_preprocessor (*PreprocessorType*, *optional*):
            Optional input preprocessor to use. Examples include
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverImagePreprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverAudioPreprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverTextPreprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverMultimodalPreprocessor*.
        output_postprocessor (*PostprocessorType*, *optional*):
            Optional output postprocessor to use. Examples include
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverImagePostprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverAudioPostprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverClassificationPostprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverProjectionPostprocessor*,
            *myTransformers.models.perceiver.modeling_perceiver.PerceiverMultimodalPostprocessor*.
...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import PerceiverConfig, PerceiverTokenizer, PerceiverImageProcessor, PerceiverModel
        >>> from myTransformers.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np
