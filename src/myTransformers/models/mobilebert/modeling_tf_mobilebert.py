...
# Copied from myTransformers.models.bert.modeling_tf_bert.TFBertPreTrainingLoss
...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel, TFMobileBertPreTrainingLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from myTransformers import AutoTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from myTransformers import AutoTokenizer, TFMobileBertForNextSentencePrediction
