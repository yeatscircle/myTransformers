...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import MobileBertConfig, MobileBertModel
...
# Copied from myTransformers.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert
