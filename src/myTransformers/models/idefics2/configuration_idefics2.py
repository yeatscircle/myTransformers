...
class Idefics2VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers.models.idefics2.modeling_idefics2 import Idefics2VisionTransformer
    >>> from myTransformers.models.idefics2.configuration_idefics2 import Idefics2VisionConfig
...
class Idefics2Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from myTransformers import Idefics2Model, Idefics2Config
