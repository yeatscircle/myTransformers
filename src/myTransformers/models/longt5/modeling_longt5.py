...
# Copied from myTransformers.models.t5.modeling_t5.T5LayerNorm with T5->LongT5
...
# Copied from myTransformers.models.t5.modeling_t5.T5DenseActDense with T5->LongT5
...
# Copied from myTransformers.models.t5.modeling_t5.T5LayerFF with T5->LongT5
...
# Copied from myTransformers.models.t5.modeling_t5.T5Attention with T5->LongT5
...
class LongT5LocalAttention(nn.Module):
    ...
    # Copied from myTransformers.models.t5.modeling_t5.T5Attention.prune_heads
    def prune_heads(self, heads):
        if len(heads) == 0:
            return
        heads, index = find_pruneable_heads_and_indices(
...
# Copied from myTransformers.models.t5.modeling_t5.T5LayerSelfAttention with T5->LongT5
...
# Copied from myTransformers.models.t5.modeling_t5.T5LayerCrossAttention with T5->LongT5
...
class LongT5PreTrainedModel(PreTrainedModel):
    ...
    @property
    # Copied from myTransformers.models.t5.modeling_t5.T5PreTrainedModel.dummy_inputs
    ...
    # Copied from myTransformers.models.t5.modeling_t5.T5PreTrainedModel._shift_right with T5->LongT5
...
class LongT5Model(LongT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, LongT5Model
