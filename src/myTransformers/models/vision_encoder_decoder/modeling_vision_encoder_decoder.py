...
# Copied from myTransformers.models.encoder_decoder.modeling_encoder_decoder.shift_tokens_right
...
class VisionEncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    :meth*~myTransformers.AutoModel.from_pretrained* class method for the encoder and
    :meth*~myTransformers.AutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from myTransformers import VisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        ...
        if from_tf:
            from myTransformers import TFVisionEncoderDecoderModel
            ...
            # There was a (very) ugly potential fix, which wasn't integrated to `myTransformers`: see
            #   https://github.com/huggingface/transformers/pull/13222/commits/dbb3c9de76eee235791d2064094654637c99f36d#r697304245
            #   (the change in `src/myTransformers/modeling_tf_utils.py`)
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import VisionEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoProcessor, VisionEncoderDecoderModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch
