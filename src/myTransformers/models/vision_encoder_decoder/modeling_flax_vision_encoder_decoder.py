...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    another one as decoder module when created with the :meth*~myTransformers.FlaxAutoModel.from_pretrained* class method
    for the encoder and :meth*~myTransformers.FlaxAutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def encode(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from myTransformers import FlaxVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import FlaxVisionEncoderDecoderModel
