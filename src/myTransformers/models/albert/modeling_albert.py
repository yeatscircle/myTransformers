...
class AlbertAttention(nn.Module):
    ...
    # Copied from myTransformers.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, AlbertForPreTraining
        >>> import torch
...
class AlbertForMaskedLM(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoTokenizer, AlbertForMaskedLM
