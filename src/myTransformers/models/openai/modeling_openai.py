...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->OpenAIGPT
...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, OpenAIGPTDoubleHeadsModel
        >>> import torch
