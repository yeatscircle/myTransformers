...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from myTransformers import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ChineseCLIPConfig, ChineseCLIPModel
