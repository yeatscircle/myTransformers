...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
# Copied from myTransformers.models.bart.modeling_bart.BartFlashAttention2 with Bart->Wav2Vec2
...
class Wav2Vec2SdpaAttention(Wav2Vec2Attention):
    # Copied from myTransformers.models.bart.modeling_bart.BartSdpaAttention.forward with Bart->Wav2Vec2
    def forward(
        self,
        hidden_states: torch.Tensor,
        key_value_states: Optional[torch.Tensor] = None,
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoFeatureExtractor, Wav2Vec2ForPreTraining
