...
from myTransformers.models.wav2vec2.modeling_wav2vec2 import Wav2Vec2ForSequenceClassification
...
def set_recursively(key, value, full_name, weight_type, hf_pointer):
    ...
    # fairseq uses nn.utils.weight_norm() while myTransformers switches to nn.utils.parametrizations.weight_norm()
