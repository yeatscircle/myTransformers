...
# Copied from myTransformers.models.clip.modeling_clip.clip_loss with clip->groupvit
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->GroupViT
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->GroupViT
...
class GroupViTTextModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import CLIPTokenizer, GroupViTTextModel
...
class GroupViTVisionModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, GroupViTVisionModel
...
class GroupViTModel(GroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import CLIPTokenizer, GroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, GroupViTModel
