...
# Copied from myTransformers.models.llava_next.image_processing_llava_next.divide_to_patches
...
# Copied from myTransformers.models.llava_next.image_processing_llava_next.expand_to_square
...
# Copied from myTransformers.models.llava_next.image_processing_llava_next._get_patch_output_size
...
class LlavaOnevisionImageProcessor(BaseImageProcessor):
    ...
    # Copied from myTransformers.models.llava_next.image_processing_llava_next.LlavaNextImageProcessor.pad
    def pad(
        self,
        image: np.ndarray,
    ...
    # Copied from myTransformers.models.llava_next.image_processing_llava_next.LlavaNextImageProcessor._resize_for_patching
    ...
    # Copied from myTransformers.models.llava_next.image_processing_llava_next.LlavaNextImageProcessor._pad_for_patching
    ...
    # Copied from myTransformers.models.llava_next.image_processing_llava_next.LlavaNextImageProcessor.get_image_patches
    ...
    # Copied from myTransformers.models.llava_next.image_processing_llava_next.LlavaNextImageProcessor._pad_for_batching
