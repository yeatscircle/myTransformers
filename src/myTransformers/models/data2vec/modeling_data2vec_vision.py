...
@dataclass
# Copied from myTransformers.models.beit.modeling_beit.BeitModelOutputWithPooling with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.drop_path
...
# Copied from myTransformers.models.beit.modeling_beit.BeitDropPath with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitEmbeddings with Beit->Data2VecVision
class Data2VecVisionEmbeddings(nn.Module):
    ...
    # Copied from myTransformers.models.vit.modeling_vit.ViTEmbeddings.interpolate_pos_encoding
    ...
    def forward(
        ...
        if self.position_embeddings is not None and interpolate_pos_encoding is not None:
            warnings.warn(
                ...
                "interpolated to the input image size. The argument will be removed in myTransformers v4.51.0."
            )
...
# Copied from myTransformers.models.beit.modeling_beit.BeitPatchEmbeddings with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitSelfAttention with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitSdpaSelfAttention with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitSelfOutput with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitIntermediate with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitOutput with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitLayer with Beit->Data2VecVision,BEiT->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitRelativePositionBias with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitEncoder with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitPreTrainedModel with Beit->Data2VecVision,beit->data2vec_vision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitModel with BEIT->DATA2VEC_VISION,Beit->Data2VecVision,True->False
...
# Copied from myTransformers.models.beit.modeling_beit.BeitPooler with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitForImageClassification with BEIT->DATA2VEC_VISION,Beit->Data2VecVision,beit->data2vec_vision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitConvModule with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitPyramidPoolingBlock with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitPyramidPoolingModule with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitUperHead with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitFCNHead with Beit->Data2VecVision
...
# Copied from myTransformers.models.beit.modeling_beit.BeitForSemanticSegmentation with BEIT->DATA2VEC_VISION,Beit->Data2VecVision,microsoft/beit-base-finetuned-ade-640-640->facebook/data2vec-vision-base,beit->data2vec_vision
class Data2VecVisionForSemanticSegmentation(Data2VecVisionPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, Data2VecVisionForSemanticSegmentation
