...
from myTransformers import Olmo2Config, Olmo2ForCausalLM
from myTransformers.models.gpt2.tokenization_gpt2_fast import GPT2TokenizerFast
...
```
python src/myTransformers/models/olmo2/convert_olmo2_weights_to_hf.py \
...
```py
from myTransformers import Olmo2ForCausalLM, AutoTokenizer
