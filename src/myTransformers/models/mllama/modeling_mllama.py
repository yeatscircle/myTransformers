...
# Copied from myTransformers.models.clip.modeling_clip.CLIPMLP with CLIP->MllamaVision
...
# Copied from myTransformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->MllamaText
...
# Copied from myTransformers.models.gemma2.modeling_gemma2.Gemma2MLP with Gemma2->MllamaText
...
# Modified from myTransformers.models.llama.modeling_llama.LlamaDecoderLayer
...
class MllamaVisionModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, MllamaVisionModel
...
class MllamaTextModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoProcessor, MllamaTextModel
...
class MllamaForCausalLM(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, MllamaForCausalLM
...
class MllamaForConditionalGeneration(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, MllamaForConditionalGeneration
