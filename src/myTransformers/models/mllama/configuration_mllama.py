...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import MllamaVisionConfig, MllamaVisionModel
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import MllamaTextModel, MllamaTextConfig
...
class MllamaConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import MllamaForConditionalGeneration, MllamaConfig, MllamaVisionConfig, MllamaTextConfig
