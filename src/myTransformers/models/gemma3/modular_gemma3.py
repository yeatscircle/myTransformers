...
class Gemma3TextConfig(Gemma2Config):
    ...
    ```python
    >>> from myTransformers import Gemma3TextModel, Gemma3TextConfig
...
class Gemma3Config(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import Gemma3ForConditionalGeneration, Gemma3Config, SiglipVisionConfig, Gemma3TextConfig
...
class Gemma3ForConditionalGeneration(PaliGemmaForConditionalGeneration):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, Gemma3ForConditionalGeneration
