...
# Copied from myTransformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->TrOCR
...
# Copied from myTransformers.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->TrOCR
