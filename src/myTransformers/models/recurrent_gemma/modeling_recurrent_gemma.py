...
# Copied from myTransformers.models.gemma.modeling_gemma.GemmaRMSNorm with Gemma->RecurrentGemma
...
# TODO: re-enable check: Copied from myTransformers.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->RECURRENTGEMMA,Llama->RecurrentGemma,llama->gemma
class RecurrentGemmaForCausalLM(RecurrentGemmaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, RecurrentGemmaForCausalLM
