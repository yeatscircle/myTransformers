...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import DPRReader, DPRReaderTokenizer
