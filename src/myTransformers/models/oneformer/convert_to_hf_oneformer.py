...
try:
    ...
    pass
from myTransformers import CLIPTokenizer, DinatConfig, SwinConfig
from myTransformers.models.oneformer.image_processing_oneformer import OneFormerImageProcessor
from myTransformers.models.oneformer.modeling_oneformer import (
    OneFormerConfig,
...
from myTransformers.models.oneformer.processing_oneformer import OneFormerProcessor
...
if __name__ == "__main__":
    parser = ArgumentParser(
        description=(
            "Command line to convert the original oneformer models (with swin backbone) to myTransformers"
            " implementation."
        )
    )
