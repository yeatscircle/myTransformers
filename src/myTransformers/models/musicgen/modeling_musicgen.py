...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->Musicgen
...
# Copied from myTransformers.models.bart.modeling_bart.BartFlashAttention2 with Bart->Musicgen
...
class MusicgenForConditionalGeneration(PreTrainedModel, GenerationMixin):
    ...
    def from_sub_models_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import MusicgenForConditionalGeneration
