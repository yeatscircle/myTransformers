...
# Copied from myTransformers.models.beit.modeling_beit.BeitDropPath with Beit->Swin
...
class SwinForMaskedImageModeling(SwinPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from myTransformers import AutoImageProcessor, SwinForMaskedImageModeling
        >>> import torch
