...
# Copied from myTransformers.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->BigBirdPegasus
...
# Copied from myTransformers.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from myTransformers.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with BartConfig->BigBirdPegasusConfig, Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(nn.Module):
    ...
    # Copied from myTransformers.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from myTransformers.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, BigBirdPegasusForConditionalGeneration
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod  # Copied from myTransformers.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
class BigBirdPegasusModel(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from myTransformers.models.bart.modeling_bart.BartModel.forward with Bart->BigBirdPegasus
    def forward(
        self,
...
# Copied from myTransformers.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
class BigBirdPegasusForSequenceClassification(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from myTransformers.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
...
class BigBirdPegasusForQuestionAnswering(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from myTransformers.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
        input_ids: Optional[torch.Tensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from myTransformers.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, BigBirdPegasusForCausalLM
