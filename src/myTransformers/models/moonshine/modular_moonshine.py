...
class MoonshineConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import MoonshineModel, MoonshineConfig
...
class MoonshineModel(WhisperModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoFeatureExtractor, MoonshineModel
...
class MoonshineForConditionalGeneration(MoonshinePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoProcessor, MoonshineForConditionalGeneration
        >>> from datasets import load_dataset
