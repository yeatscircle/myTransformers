...
class IdeficsForVisionText2Text(IdeficsPreTrainedModel, GenerationMixin):
    ...
    def tie_weights(self):
        """
        Overwrite `myTransformers.modeling_utils.PreTrainedModel.tie_weights` to handle the case of
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoProcessor, IdeficsForVisionText2Text
