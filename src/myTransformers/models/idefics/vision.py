...
# Adapted from myTransformers.models.clip.modeling_clip.CLIPVisionEmbeddings
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPMLP with CLIP->IdeficsVision
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->IdeficsVision
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->IdeficsVision
...
# Adapted from myTransformers.models.clip.modeling_clip.CLIPVisionTransformer
class IdeficsVisionTransformer(nn.Module):
    ...
    # Adapted from myTransformers.models.clip.modeling_clip.CLIPVisionTransformer.forward
    def forward(
        self,
