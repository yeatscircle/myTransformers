...
class UperNetConfig(PretrainedConfig):
    ...
    Args:
        ...
        backbone (`str`, *optional*):
            ...
            will load the corresponding pretrained weights from the timm or myTransformers library. If `use_pretrained_backbone`
            is `False`, this loads the backbone's config and uses that to initialize the backbone with random weights.
        use_pretrained_backbone (`bool`, *optional*, `False`):
            Whether to use pretrained weights for the backbone.
        use_timm_backbone (`bool`, *optional*, `False`):
            Whether to load `backbone` from the timm library. If `False`, the backbone is loaded from the myTransformers
            library.
    ...
    ```python
    >>> from myTransformers import UperNetConfig, UperNetForSemanticSegmentation
