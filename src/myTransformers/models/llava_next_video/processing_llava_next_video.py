...
class LlavaNextVideoProcessor(ProcessorMixin):
    ...
    # Copied from myTransformers.models.llava_next.processing_llava_next.LlavaNextProcessor._get_number_of_features
    ...
    # Copied from myTransformers.models.llava_next.processing_llava_next.LlavaNextProcessor._get_unpadded_features
    ...
    # Copied from myTransformers.models.clip.processing_clip.CLIPProcessor.batch_decode with CLIP->Llama
    ...
    # Copied from myTransformers.models.clip.processing_clip.CLIPProcessor.decode with CLIP->Llama
    ...
    @property
    # Copied from myTransformers.models.clip.processing_clip.CLIPProcessor.model_input_names
