...
from myTransformers.models.llava_next.modeling_llava_next import (
...
class LlavaNextVideoConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import LlavaNextVideoForConditionalGeneration, LlavaNextVideoConfig, CLIPVisionConfig, LlamaConfig
...
class LlavaNextVideoForConditionalGeneration(LlavaNextForConditionalGeneration):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> import requests
        >>> import av
        >>> from myTransformers import AutoProcessor, LlavaNextVideoForConditionalGeneration
