...
class TableTransformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import TableTransformerModel, TableTransformerConfig
    ...
    # Copied from myTransformers.models.detr.configuration_detr.DetrConfig.__init__
    def __init__(
        self,
        use_timm_backbone=True,
...
# Copied from myTransformers.models.detr.configuration_detr.DetrOnnxConfig
