...
@dataclass
# Copied from myTransformers.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->Clap
...
@dataclass
# Copied from myTransformers.models.clip.modeling_clip.CLIPOutput with CLIP->Clap, vision->audio, Vision->Audio, image->audio
...
# Adapted from myTransformers.models.swin.modeling_swin.SwinDropPath
...
# Copied from myTransformers.models.swin.modeling_swin.SwinSelfAttention with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinSelfOutput with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinAttention with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinIntermediate with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinOutput with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinLayer with SwinDropPath->ClapDropPath, Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinStage with Swin->ClapAudio
...
# Copied from myTransformers.models.swin.modeling_swin.SwinPatchMerging with Swin->ClapAudio
...
# Copied from myTransformers.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->ClapText, persistent=False->persistent=True
...
# Copied from myTransformers.models.bert.modeling_bert.BertSelfAttention with Bert->ClapText
...
# Copied from myTransformers.models.bert.modeling_bert.BertAttention with Bert->ClapText,BERT->CLAP_TEXT
...
# Copied from myTransformers.models.bert.modeling_bert.BertIntermediate
...
# Copied from myTransformers.models.bert.modeling_bert.BertOutput
...
# Copied from myTransformers.models.bert.modeling_bert.BertLayer with Bert->ClapText
...
# Copied from myTransformers.models.bert.modeling_bert.BertEncoder with Bert->ClapText
...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from myTransformers import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from myTransformers import AutoFeatureExtractor, ClapModel
        >>> import torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from myTransformers import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from myTransformers import ClapAudioModelWithProjection, ClapProcessor
