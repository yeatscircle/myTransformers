...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ClapConfig, ClapModel
    ...
    >>> from myTransformers import ClapTextConfig, ClapAudioConfig
