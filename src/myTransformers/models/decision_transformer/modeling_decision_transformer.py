...
# Copied from myTransformers.models.gpt2.modeling_gpt2.load_tf_weights_in_gpt2
...
# Copied from myTransformers.models.gpt2.modeling_gpt2.eager_attention_forward
...
# Copied from myTransformers.models.gpt2.modeling_gpt2.GPT2Attention with GPT2->DecisionTransformerGPT2
...
# Copied from myTransformers.models.gpt2.modeling_gpt2.GPT2MLP with GPT2->DecisionTransformerGPT2
...
# Copied from myTransformers.models.gpt2.modeling_gpt2.GPT2Block with GPT2->DecisionTransformerGPT2
...
class DecisionTransformerGPT2Model(DecisionTransformerGPT2PreTrainedModel):
    ...
    def forward(
        ...
        # based on pattern from src/myTransformers/models/whisper/modeling_whisper.py::WhisperDecoder and similar addition in GPT2Model
...
class DecisionTransformerModel(DecisionTransformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import DecisionTransformerModel
        >>> import torch
