...
EPILOG_TXT = """Example:
    python myTransformers/src/myTransformers/models/idefics3/convert_idefics3_weights_to_hf.py --original_model_id HuggingFaceM4/Idefics3-8B-Llama3 --output_hub_path org/idefics3
"""
