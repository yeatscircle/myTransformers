...
class Idefics3VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers.models.idefics3.modeling_idefics3 import Idefics3VisionTransformer
    >>> from myTransformers.models.idefics3.configuration_idefics3 import Idefics3VisionConfig
...
class Idefics3Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from myTransformers import Idefics3Model, Idefics3Config
