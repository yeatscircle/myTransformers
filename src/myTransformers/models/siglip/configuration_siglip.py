...
class SiglipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import SiglipTextConfig, SiglipTextModel
...
class SiglipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import SiglipVisionConfig, SiglipVisionModel
...
class SiglipConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import SiglipConfig, SiglipModel
    ...
    >>> from myTransformers import SiglipTextConfig, SiglipVisionConfig
