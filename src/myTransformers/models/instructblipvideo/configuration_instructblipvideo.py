#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/myTransformers/models/instructblipvideo/modular_instructblipvideo.py.
...
class InstructBlipVideoVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import InstructBlipVideoVisionConfig, InstructBlipVideoVisionModel
...
class InstructBlipVideoQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import InstructBlipVideoQFormerConfig, InstructBlipVideoQFormerModel
