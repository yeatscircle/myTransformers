...
# Copied from myTransformers.models.blenderbot.modeling_blenderbot.BlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->BlenderbotSmall
...
# Copied from myTransformers.models.bart.modeling_bart.BartEncoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, BlenderbotSmallForConditionalGeneration
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, BlenderbotSmallModel
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->BlenderbotSmall
...
# Copied from myTransformers.models.bart.modeling_bart.BartForCausalLM with Bart->BlenderbotSmall, facebook/bart-base->facebook/blenderbot_small-90M
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, BlenderbotSmallForCausalLM
