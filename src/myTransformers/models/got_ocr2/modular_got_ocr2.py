...
from myTransformers.modeling_outputs import CausalLMOutputWithPast
from myTransformers.models.llava.modeling_llava import (
    LlavaCausalLMOutputWithPast,
    LlavaForConditionalGeneration,
    LlavaPreTrainedModel,
)
from myTransformers.models.sam.modeling_sam import SamMLPBlock, SamVisionAttention, SamVisionEncoder, SamVisionLayer
...
class GotOcr2Config(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import GotOcr2ForConditionalGeneration, GotOcr2Config
...
class GotOcr2ForConditionalGeneration(LlavaForConditionalGeneration):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, GotOcr2ForConditionalGeneration, TextStreamer
