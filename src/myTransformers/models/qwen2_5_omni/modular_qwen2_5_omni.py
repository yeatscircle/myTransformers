...
from myTransformers.models.llama.modeling_llama import rotate_half
from myTransformers.models.qwen2.configuration_qwen2 import Qwen2Config
from myTransformers.models.qwen2_5_vl.configuration_qwen2_5_vl import Qwen2_5_VLVisionConfig
from myTransformers.models.qwen2_5_vl.modeling_qwen2_5_vl import (
...
from myTransformers.models.qwen2_audio.configuration_qwen2_audio import Qwen2AudioEncoderConfig
from myTransformers.models.qwen2_audio.modeling_qwen2_audio import Qwen2AudioEncoderLayer
from myTransformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLRotaryEmbedding
...
class Qwen2_5OmniVisionEncoderConfig(Qwen2_5_VLVisionConfig):
    ...
    ```python
    >>> from myTransformers import Qwen2_5OmniVisionEncoderConfig, Qwen2_5OmniVisionEncoder
...
class Qwen2_5OmniAudioEncoderConfig(Qwen2AudioEncoderConfig):
    ...
    ```python
    >>> from myTransformers import Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniAudioEncoder
...
class Qwen2_5OmniTextConfig(Qwen2Config):
    ...
    ```python
    >>> from myTransformers import Qwen2_5OmniThinkerForConditionalGeneration, Qwen2_5OmniThinkerConfig, Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniVisionEncoderConfig
...
class Qwen2_5OmniTalkerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import Qwen2_5OmniTalkerForConditionalGeneration, Qwen2_5OmniThinkerConfig, Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniVisionEncoderConfig
...
class Qwen2_5OmniToken2WavConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import Qwen2_5OmniToken2WavModel, DiT_Args, BigVGAN_Args
...
class Qwen2_5OmniThinkerForConditionalGeneration(Qwen2_5OmniPreTrainedModelForConditionalGeneration, GenerationMixin):
    ...
    def forward(
        ...
        >>> from myTransformers import Qwen2_5OmniProcessor, Qwen2_5OmniThinkerForConditionalGeneration
...
class Qwen2_5OmniTalkerForConditionalGeneration(Qwen2_5OmniPreTrainedModelForConditionalGeneration, GenerationMixin):
    ...
    def forward(
        ...
        >>> from urllib.request import urlopen
        >>> import librosa
        >>> from myTransformers import AutoProcessor, Qwen2_5OmniTalkerForConditionalGeneration
