...
from myTransformers import OlmoConfig, OlmoForCausalLM
...
```
python src/myTransformers/models/olmo/convert_olmo_weights_to_hf.py \
...
```py
from myTransformers import OlmoForCausalLM, AutoTokenizer
