...
# Copied from myTransformers.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
# Copied from myTransformers.models.bert.modeling_bert.BertSdpaSelfAttention with Bert->XLMRobertaXL
...
class XLMRobertaXLPreTrainedModel(PreTrainedModel):
    ...
    # Copied from myTransformers.models.bert.modeling_bert.BertPreTrainedModel._init_weights with BertLMPredictionHead->XLMRobertaXLLMHead
...
# Copied from myTransformers.models.bert.modeling_bert.BertModel with Bert->XLMRobertaXL, BERT->XLM_ROBERTA_XL
...
class XLMRobertaXLForCausalLM(XLMRobertaXLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, RobertaForCausalLM, RobertaConfig
        >>> import torch
