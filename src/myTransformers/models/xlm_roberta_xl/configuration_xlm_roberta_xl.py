...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import XLMRobertaXLConfig, XLMRobertaXLModel
...
# Copied from myTransformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL
