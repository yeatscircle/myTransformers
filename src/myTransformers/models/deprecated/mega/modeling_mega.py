...
class MegaEmbeddings(nn.Module):
    ...
    def __init__(self, config: MegaConfig):
        ...
        if self.use_token_types:
            ...
            # more info at myTransformers issue #5664
...
# copied from myTransformers.models.roberta.modeling_roberta.RobertaPooler with Roberta->Mega
...
class MegaForCausalLM(MegaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, MegaForCausalLM, AutoConfig
        >>> import torch
...
# copied from myTransformers.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Mega
