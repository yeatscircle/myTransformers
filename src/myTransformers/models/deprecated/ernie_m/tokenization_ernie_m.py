...
# Adapted from paddlenlp.myTransformers.ernie_m.tokenizer.ErnieMTokenizer
...
class ErnieMTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # to mimic paddlenlp.myTransformers.ernie_m.tokenizer.ErnieMTokenizer functioning
