...
# Based on myTransformers.models.bert.modeling_bert.BertAttention with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertLayer with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertEncoder with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertLMPredictionHead with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertPreTrainingHeads with Bert -> QDQBert
...
# Based on myTransformers.models.bert.modeling_bert.BertPreTrainedModel with Bert -> QDQBert
...
class QDQBertLMHeadModel(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, QDQBertLMHeadModel, QDQBertConfig
        >>> import torch
...
class QDQBertForNextSentencePrediction(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, QDQBertForNextSentencePrediction
        >>> import torch
