...
class XLMProphetNetEncoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XLMProphetNetEncoder
        >>> import torch
...
class XLMProphetNetDecoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XLMProphetNetDecoder
        >>> import torch
...
class XLMProphetNetModel(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, XLMProphetNetForCausalLM
        >>> import torch
