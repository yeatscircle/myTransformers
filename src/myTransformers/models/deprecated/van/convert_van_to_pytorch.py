...
from myTransformers import AutoImageProcessor, VanConfig, VanForImageClassification
from myTransformers.models.deprecated.van.modeling_van import VanLayerScaling
