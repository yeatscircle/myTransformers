...
# Copied from myTransformers.models.resnet.modeling_resnet.ResNetConvLayer -> RTDetrResNetConvLayer
...
# Copied from myTransformers.models.resnet.modeling_resnet.ResNetShortCut -> RTDetrResNetChortCut
...
# Copied from myTransformers.models.resnet.modeling_resnet.ResNetEncoder with ResNet->RTDetrResNet
...
# Copied from myTransformers.models.resnet.modeling_resnet.ResNetPreTrainedModel with ResNet->RTDetrResNet
...
class RTDetrResNetBackbone(RTDetrResNetPreTrainedModel, BackboneMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import RTDetrResNetConfig, RTDetrResNetBackbone
        >>> import torch
