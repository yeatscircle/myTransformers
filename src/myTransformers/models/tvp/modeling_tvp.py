...
# Copied from myTransformers.models.bert.modeling_bert.BertIntermediate with Bert->Tvp
...
# Copied from myTransformers.models.bert.modeling_bert.BertPooler with Bert->Tvp
...
class TvpModel(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoConfig, AutoTokenizer, TvpModel
...
class TvpForVideoGrounding(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoConfig, AutoTokenizer, TvpForVideoGrounding
