...
class BridgeTowerVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BridgeTowerVisionConfig
...
class BridgeTowerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BridgeTowerTextConfig
...
class BridgeTowerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BridgeTowerModel, BridgeTowerConfig
