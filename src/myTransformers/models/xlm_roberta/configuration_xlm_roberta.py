...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import XLMRobertaConfig, XLMRobertaModel
...
# Copied from myTransformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta
