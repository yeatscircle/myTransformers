...
class DepthProModel(DepthProPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, DepthProModel
...
# Copied from myTransformers.models.dpt.modeling_dpt.DPTPreActResidualLayer DPT->DepthPro
...
# Modified from myTransformers.models.dpt.modeling_dpt.DPTFeatureFusionLayer
...
# Modified from myTransformers.models.dpt.modeling_dpt.DPTFeatureFusionStage with DPT->DepthPro
...
class DepthProForDepthEstimation(DepthProPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, DepthProForDepthEstimation
        >>> import torch
        >>> from PIL import Image
        >>> import requests
