...
class Owlv2Processor(ProcessorMixin):
    ...
    # For backward compatibility. See myTransformers.processing_utils.ProcessorMixin.prepare_and_validate_optional_call_args for more details.
    optional_call_args = ["query_images"]

    def __init__(self, image_processor, tokenizer, **kwargs):
        super().__init__(image_processor, tokenizer)

    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.__call__ with OwlViT->Owlv2
    def __call__(
        self,
        images: Optional[ImageInput] = None,
        text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = None,
        # The following is to capture `query_images` argument that may be passed as a positional argument.
        # See myTransformers.processing_utils.ProcessorMixin.prepare_and_validate_optional_call_args for more details,
    ...
    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.post_process_object_detection with OwlViT->Owlv2
    ...
    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.post_process_grounded_object_detection with OwlViT->Owlv2
    ...
    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.post_process_image_guided_detection with OwlViT->Owlv2
    ...
    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.batch_decode
    ...
    # Copied from myTransformers.models.owlvit.processing_owlvit.OwlViTProcessor.decode
