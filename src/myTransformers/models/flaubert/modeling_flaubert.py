...
# Copied from myTransformers.models.xlm.modeling_xlm.create_sinusoidal_embeddings
...
# Copied from myTransformers.models.xlm.modeling_xlm.get_masks
...
# Copied from myTransformers.models.xlm.modeling_xlm.MultiHeadAttention
...
# Copied from myTransformers.models.xlm.modeling_xlm.TransformerFFN
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMPredLayer with XLM->Flaubert
...
@dataclass
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSquadHeadOutput with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMPoolerStartLogits with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMPoolerEndLogits with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMPoolerAnswerClass with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSQuADHead with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMPreTrainedModel with XLM->Flaubert
...
class FlaubertModel(FlaubertPreTrainedModel):
    ...
    # Copied from myTransformers.models.xlm.modeling_xlm.XLMModel.get_input_embeddings
    def get_input_embeddings(self):
        return self.embeddings

    # Copied from myTransformers.models.xlm.modeling_xlm.XLMModel.set_input_embeddings
    def set_input_embeddings(self, new_embeddings):
        self.embeddings = new_embeddings

    # Copied from myTransformers.models.xlm.modeling_xlm.XLMModel._prune_heads
...
# Copied myTransformers.models.xlm.modeling_xlm.XLMWithLMHeadModel with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMForSequenceClassification with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMForTokenClassification with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMForQuestionAnsweringSimple with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMForQuestionAnswering with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
class FlaubertForQuestionAnswering(FlaubertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, FlaubertForQuestionAnswering
        >>> import torch
...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMForMultipleChoice with XLM_INPUTS->FLAUBERT_INPUTS,XLM->Flaubert
