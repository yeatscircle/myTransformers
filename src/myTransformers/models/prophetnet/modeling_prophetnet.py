...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ProphetNetEncoder
        >>> import torch
...
class ProphetNetDecoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ProphetNetDecoder
        >>> import torch
...
class ProphetNetModel(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ProphetNetModel
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ProphetNetForConditionalGeneration
    ...
    @staticmethod
    # Copied from myTransformers.models.bart.modeling_bart.BartForConditionalGeneration._reorder_cache
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, ProphetNetForCausalLM
        >>> import torch
        ...
        >>> from myTransformers import BertTokenizer, EncoderDecoderModel, AutoTokenizer
        >>> import torch
    ...
    @staticmethod
    # Copied from myTransformers.models.bart.modeling_bart.BartForCausalLM._reorder_cache
    def _reorder_cache(past_key_values, beam_idx):
        reordered_past = ()
        for layer_past in past_key_values:
            reordered_past += (
