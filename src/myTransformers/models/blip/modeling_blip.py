...
# Copied from myTransformers.models.clip.modeling_clip.clip_loss with clip->blip
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->Blip
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPMLP with CLIP->Blip
...
class BlipModel(BlipPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import AutoProcessor, BlipModel
...
class BlipForConditionalGeneration(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, BlipForConditionalGeneration
...
class BlipForQuestionAnswering(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, BlipForQuestionAnswering
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, BlipForImageTextRetrieval
