...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import BlipConfig, BlipModel
