...
# PYTHONPATH=/tmp/Megatron-LM python src/myTransformers/models/megatron_bert/convert_megatron_bert_checkpoint.py ...
#
...
from myTransformers import MegatronBertConfig
