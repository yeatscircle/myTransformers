...
# Copied from myTransformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MVP
...
# Copied from myTransformers.models.bart.modeling_bart.BartClassificationHead with Bart->MVP
...
MVP_CONDITIONAL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from myTransformers import AutoTokenizer, MvpForConditionalGeneration
...
MVP_SEQUENCE_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from myTransformers import AutoTokenizer, MvpForSequenceClassification
...
MVP_QUESTION_ANSWERING_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from myTransformers import AutoTokenizer, MvpForQuestionAnswering
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->Mvp
...
class MvpForCausalLM(MvpPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, MvpForCausalLM
