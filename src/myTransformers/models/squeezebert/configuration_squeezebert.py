...
class SqueezeBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import SqueezeBertConfig, SqueezeBertModel
...
# # Copied from myTransformers.models.bert.configuration_bert.BertOnxxConfig with Bert->SqueezeBert
