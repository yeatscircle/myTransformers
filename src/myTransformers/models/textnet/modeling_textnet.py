...
from myTransformers import PreTrainedModel, add_start_docstrings
from myTransformers.activations import ACT2CLS
...
from myTransformers.models.textnet.configuration_textnet import TextNetConfig
...
from myTransformers.utils.backbone_utils import BackboneMixin
...
class TextNetForImageClassification(TextNetPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> import requests
        >>> from myTransformers import TextNetForImageClassification, TextNetImageProcessor
