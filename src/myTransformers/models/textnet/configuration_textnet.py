...
from myTransformers.utils.backbone_utils import BackboneConfigMixin, get_aligned_output_features_output_indices
...
class TextNetConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import TextNetConfig, TextNetBackbone
