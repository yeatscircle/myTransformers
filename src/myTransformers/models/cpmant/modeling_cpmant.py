...
# Copied from myTransformers.models.bert.modeling_bert.BertIntermediate with Bert->CPMAnt
...
# Copied from myTransformers.models.bert.modeling_bert.BertOutput with Bert->CPMAnt
...
class CpmAntForCausalLM(CpmAntPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import CPMAntTokenizer, CpmAntForCausalLM
