...
from myTransformers.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from myTransformers.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from myTransformers.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from myTransformers import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer

    config = SwitchTransformersConfig.from_pretrained("google/switch-base-8")
    config.save_pretrained("/home/arthur_huggingface_co/myTransformers/switch_converted")
    model = SwitchTransformersForConditionalGeneration.from_pretrained(
        "/home/arthur_huggingface_co/myTransformers/switch_converted", device_map="auto"
    )
