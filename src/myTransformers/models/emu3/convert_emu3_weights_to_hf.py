...
from myTransformers.models.gpt2.tokenization_gpt2 import bytes_to_unicode
...
```
python src/myTransformers/models/emu3/convert_emu3_weights_to_hf.py \
...
```py
from myTransformers import Emu3ForConditionalGeneration, Emu3Processor
