...
class Siglip2TextModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, Siglip2TextModel
...
class Siglip2VisionModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, Siglip2VisionModel
...
class Siglip2ForImageClassification(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, Siglip2ForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
