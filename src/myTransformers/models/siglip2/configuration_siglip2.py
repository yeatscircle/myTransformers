#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/myTransformers/models/siglip2/modular_siglip2.py.
...
class Siglip2TextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import Siglip2TextConfig, Siglip2TextModel
...
class Siglip2Config(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import Siglip2Config, Siglip2Model
    ...
    >>> from myTransformers import Siglip2TextConfig, Siglip2VisionConfig
