...
from myTransformers.models.siglip.configuration_siglip import SiglipConfig, SiglipTextConfig, SiglipVisionConfig
from myTransformers.models.siglip.modeling_siglip import (
    BaseModelOutput,
...
class Siglip2VisionConfig(SiglipVisionConfig):
    ...
    ```python
    >>> from myTransformers import Siglip2VisionConfig, Siglip2VisionModel
