...
# Copied from myTransformers.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, TFSegformerForSemanticSegmentation
