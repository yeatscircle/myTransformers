...
@dataclass
# Copied from myTransformers.models.blip_2.modeling_blip_2.Blip2ForConditionalGenerationModelOutput with Blip2->InstructBlip
...
# Copied from myTransformers.models.blip.modeling_blip.BlipVisionEmbeddings with Blip->InstructBlip
...
# Copied from myTransformers.models.blip_2.modeling_blip_2.Blip2Attention with Blip2->InstructBlip
...
# Copied from myTransformers.models.blip.modeling_blip.BlipEncoderLayer with Blip->InstructBlip
...
# Copied from myTransformers.models.blip.modeling_blip.BlipEncoder with Blip->InstructBlip
...
# Copied from myTransformers.models.blip.modeling_blip.BlipVisionModel with Blip->InstructBlip, BLIP->INSTRUCTBLIP
...
# Copied from myTransformers.models.bert.modeling_bert.BertSelfOutput with Bert->InstructBlipQFormer
...
# Copied from myTransformers.models.blip_2.modeling_blip_2.Blip2QFormerAttention with Blip2->InstructBlip
...
# Copied from myTransformers.models.bert.modeling_bert.BertIntermediate with Bert->InstructBlipQFormer
...
# Copied from myTransformers.models.bert.modeling_bert.BertOutput with Bert->InstructBlipQFormer
...
# Copied from myTransformers.models.blip_2.modeling_blip_2.Blip2QFormerEncoder with Blip2->InstructBlip
...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import InstructBlipProcessor, InstructBlipForConditionalGeneration
        >>> import torch
