...
class InstructBlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import InstructBlipVisionConfig, InstructBlipVisionModel
...
class InstructBlipQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import InstructBlipQFormerConfig, InstructBlipQFormerModel
