...
class PatchTSMixerConfig(PretrainedConfig):
    ...
    Args:
        ...
        post_init (`bool`, *optional*, defaults to `False`):
            Whether to use custom weight initialization from `myTransformers` library, or the default initialization in
    ...
    ```python
    >>> from myTransformers import PatchTSMixerConfig, PatchTSMixerModel
