...
from myTransformers.models.blip.image_processing_blip import BlipImageProcessor
...
class JanusConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import JanusForConditionalGeneration, JanusConfig, JanusVisionConfig, JanusVQVAEConfig, LlamaConfig
