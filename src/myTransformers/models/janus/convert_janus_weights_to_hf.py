...
python src/myTransformers/models/janus/convert_janus_weights_to_hf.py --repo_id deepseek-ai/Janus-Pro-1B --local_dir tmp/hub_code_in --output_dir tmp/hub_code_out --safe_serialization
...
from myTransformers.models.janus.image_processing_janus import JanusImageProcessor
from myTransformers.models.janus.processing_janus import JanusProcessor
