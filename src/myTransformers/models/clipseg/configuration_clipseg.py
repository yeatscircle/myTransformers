...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import CLIPSegConfig, CLIPSegModel
