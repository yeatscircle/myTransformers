...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, DetrForObjectDetection
        >>> import torch
        >>> from PIL import Image
        >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        >>> from myTransformers import AutoImageProcessor, DetrForSegmentation
