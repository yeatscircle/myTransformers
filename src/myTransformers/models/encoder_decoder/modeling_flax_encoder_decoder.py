...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    decoder module when created with the :meth*~myTransformers.FlaxAutoModel.from_pretrained* class method for the
    encoder and :meth*~myTransformers.FlaxAutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def encode(
        ...
        ```python
        >>> from myTransformers import FlaxEncoderDecoderModel, BertTokenizer
    ...
    def __call__(
        ...
        ```python
        >>> from myTransformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import FlaxEncoderDecoderModel
