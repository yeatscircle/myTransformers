...
# Copied from myTransformers.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Whisper, MBART->WHISPER
...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ```python
         >>> import torch
         >>> from myTransformers import AutoFeatureExtractor, WhisperModel
...
class WhisperForConditionalGeneration(WhisperGenerationMixin, WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoProcessor, WhisperForConditionalGeneration
        >>> from datasets import load_dataset
...
class WhisperForCausalLM(WhisperPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import WhisperForCausalLM, WhisperForConditionalGeneration, WhisperProcessor
        >>> import torch
        >>> from datasets import load_dataset
...
class WhisperForAudioClassification(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoFeatureExtractor, WhisperForAudioClassification
        >>> from datasets import load_dataset
