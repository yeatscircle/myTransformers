...
# Copied from myTransformers.models.oneformer.modeling_oneformer.multi_scale_deformable_attention
...
# Copied from myTransformers.models.maskformer.modeling_maskformer.MaskFormerSinePositionEmbedding with MaskFormer->Mask2Former
...
# Modified from myTransformers.models.detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention
...
# Modified from from myTransformers.models.detr.modeling_deformable_detr.DeformableDetrEncoder with DeformableDetrEncoder->Mask2FormerPixelDecoderEncoderOnly
...
# Modified from from myTransformers.models.detr.modeling_deformable_detr.DeformableDetrModel with DeformableDetrModel->Mask2FormerPixelDecoder
...
# Modified from myTransformers.models.detr.modeling_detr.DetrAttention with Detr->Mask2Former
...
# Copied from myTransformers.models.maskformer.modeling_maskformer.PredictionBlock with MaskFormer->Mask2Former
...
class Mask2FormerModel(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoImageProcessor, Mask2FormerModel
...
class Mask2FormerForUniversalSegmentation(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, Mask2FormerForUniversalSegmentation
        >>> from PIL import Image
        >>> import requests
        >>> import torch
