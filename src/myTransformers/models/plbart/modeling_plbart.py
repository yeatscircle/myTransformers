...
# Copied from myTransformers.models.mbart.modeling_mbart.shift_tokens_right
...
# Copied from myTransformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartEncoderLayer with Bart->PLBart, BART->PLBART
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderLayer with Bart->PLBart, BART->PLBART
...
# Copied from myTransformers.models.bart.modeling_bart.BartClassificationHead with Bart->PLBart
...
PLBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, PLBartForConditionalGeneration
...
# Copied from myTransformers.models.bart.modeling_bart.BartEncoder with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoder with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->PLBart
...
# Copied from myTransformers.models.bart.modeling_bart.BartForCausalLM with Bart->PLBart, facebook/bart-base->uclanlp/plbart-base
class PLBartForCausalLM(PLBartPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, PLBartForCausalLM
