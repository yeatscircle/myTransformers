...
class Kosmos2Processor(ProcessorMixin):
    ...
    # Copied from myTransformers.models.blip.processing_blip.BlipProcessor.batch_decode with BertTokenizerFast->PreTrainedTokenizer
    ...
    # Copied from myTransformers.models.blip.processing_blip.BlipProcessor.decode with BertTokenizerFast->PreTrainedTokenizer
    ...
    @property
    # Copied from myTransformers.models.blip.processing_blip.BlipProcessor.model_input_names
