...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,  # NOOP kwargs, for now
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, CTRLModel
        >>> import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoTokenizer, CTRLLMHeadModel
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoTokenizer, CTRLForSequenceClassification
