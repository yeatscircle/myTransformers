...
@add_start_docstrings(
    ...
    ```python
    >>> from myTransformers import BarkSemanticConfig, BarkSemanticModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from myTransformers import BarkCoarseConfig, BarkCoarseModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from myTransformers import BarkFineConfig, BarkFineModel
