...
class BarkSelfAttention(nn.Module):
    ...
    # Copied from myTransformers.models.gpt_neo.modeling_gpt_neo.GPTNeoSelfAttention._split_heads
...
class BarkSemanticModel(BarkCausalModel):
    ...
    def generate(
        ...
        **kwargs,
        ...
        # pass input_ids in order to stay consistent with the myTransformers generate method even though it is not used
