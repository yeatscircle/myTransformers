...
class SmolVLMVisionConfig(Idefics3VisionConfig):
    ...
    ```python
    >>> from myTransformers.models.smolvlm.modeling_smolvlm import SmolVLMVisionTransformer
    >>> from myTransformers.models.smolvlm.configuration_smolvlm import SmolVLMVisionConfig
...
class SmolVLMConfig(Idefics3Config):
    ...
    Example:
    ```python
    >>> from myTransformers import SmolVLMModel, SmolVLMConfig
