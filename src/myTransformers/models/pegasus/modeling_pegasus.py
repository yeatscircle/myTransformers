...
# Copied from myTransformers.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from myTransformers.models.bart.modeling_bart.BartAttention with Bart->Pegasus
...
# Copied from myTransformers.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Pegasus, MBART->PEGASUS
...
# Copied from myTransformers.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Pegasus, MBART->PEGASUS
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, PegasusModel
...
# Copied from myTransformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->Pegasus
...
class PegasusForCausalLM(PegasusPreTrainedModel, GenerationMixin):
    ...
    # Copied from myTransformers.models.bart.modeling_bart.BartForCausalLM.forward with Bart->Pegasus, facebook/bart-base->google/pegasus-large
    def forward(
        self,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, PegasusForCausalLM
