...
# Copied from myTransformers.models.marian.modeling_tf_marian.TFMarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from myTransformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->Pegasus
...
# Copied from myTransformers.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Pegasus
...
# Copied from myTransformers.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Pegasus
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, TFPegasusForConditionalGeneration
