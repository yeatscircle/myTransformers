...
from myTransformers.models.qwen2_vl.configuration_qwen2_vl import Qwen2VLConfig, Qwen2VLTextConfig
from myTransformers.models.qwen2_vl.modeling_qwen2_vl import (
    PatchEmbed,
    PatchMerger,
    Qwen2RMSNorm,
...
from myTransformers.models.qwen2_vl.processing_qwen2_vl import Qwen2VLImagesKwargs, Qwen2VLProcessor
...
class Qwen2_5_VLForConditionalGeneration(Qwen2VLForConditionalGeneration):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, Qwen2_5_VLForConditionalGeneration
