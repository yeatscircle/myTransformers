...
class FlaxMT5Model(FlaxT5Model):
    ...
    ```python
    >>> from myTransformers import FlaxMT5Model, AutoTokenizer
...
class FlaxMT5EncoderModel(FlaxT5EncoderModel):
    ...
    ```python
    >>> from myTransformers import FlaxT5EncoderModel, AutoTokenizer
...
class FlaxMT5ForConditionalGeneration(FlaxT5ForConditionalGeneration):
    ...
    ```python
    >>> from myTransformers import FlaxMT5ForConditionalGeneration, AutoTokenizer
