...
# Copied from myTransformers.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->GPT2
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        # based on pattern from src/myTransformers/models/whisper/modeling_whisper.py::WhisperDecoder
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> import torch
        >>> from myTransformers import AutoTokenizer, GPT2DoubleHeadsModel
