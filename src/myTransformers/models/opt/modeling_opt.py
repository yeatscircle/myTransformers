...
class OPTDecoder(OPTPreTrainedModel):
    ...
    def __init__(self, config: OPTConfig):
        ...
        # with checkpoints that have been fine-tuned before myTransformers v4.20.1
...
class OPTForCausalLM(OPTPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, OPTForCausalLM
...
class OPTForQuestionAnswering(OPTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, OPTForQuestionAnswering
        >>> import torch
