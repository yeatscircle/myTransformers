...
# Copied from myTransformers.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->VideoLlava
...
class VideoLlavaForConditionalGeneration(VideoLlavaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> from myTransformers import VideoLlavaProcessor, VideoLlavaForConditionalGeneration
