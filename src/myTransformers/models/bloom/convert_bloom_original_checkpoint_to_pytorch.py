...
from myTransformers import BloomConfig, BloomModel
from myTransformers.file_utils import CONFIG_NAME, WEIGHTS_NAME
...
def layer_name_mapping(key, file):
    """Convert Megatron-DeepSpeed TP/PP weights mapping in myTransformers PP only"""
    ...
    if shard_model:
        ...
        for j, file in enumerate(file_names):
            ...
            for i in range(pretraining_tp):
                ...
                # Rename keys in the myTransformers names
                keys = list(temp.keys())
                for key in keys:
