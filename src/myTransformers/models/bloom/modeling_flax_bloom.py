...
class FlaxBloomAttention(nn.Module):
    ...
    @nn.compact
    # Copied from myTransformers.models.gptj.modeling_flax_gptj.FlaxGPTJAttention._concatenate_to_cache
...
# Copied from myTransformers.models.gpt_neo.modeling_flax_gpt_neo.FlaxGPTNeoModel with GPTNeo->Bloom
