...
"""This script can be used to convert checkpoints provided in the `mamba_ssm` library into the format provided in HuggingFace `myTransformers`. It depends on the `mamba_ssm` package to be installed."""
...
from myTransformers import AutoTokenizer, MambaConfig, MambaForCausalLM
from myTransformers.utils import logging
from myTransformers.utils.import_utils import is_mamba_ssm_available
...
if is_mamba_ssm_available():
    ...
    def convert_ssm_config_to_hf_config(config_ssm: MambaConfigSSM) -> MambaConfig:
        """Convert a MambaConfig from mamba_ssm to a MambaConfig from myTransformers."""
