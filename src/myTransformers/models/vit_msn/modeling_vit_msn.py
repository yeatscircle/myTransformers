...
# Copied from myTransformers.models.vit.modeling_vit.ViTPatchEmbeddings with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTSelfAttention with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTSelfOutput with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTAttention with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTIntermediate with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTOutput with ViT->ViTMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTLayer with ViT->ViTMSN, VIT->VITMSN
...
# Copied from myTransformers.models.vit.modeling_vit.ViTEncoder with ViT->ViTMSN
...
class ViTMSNModel(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, ViTMSNModel
        >>> import torch
...
class ViTMSNForImageClassification(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, ViTMSNForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
