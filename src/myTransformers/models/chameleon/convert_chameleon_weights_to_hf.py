...
```
python src/myTransformers/models/chameleon/convert_chameleon_weights_to_hf.py \
...
```py
from myTransformers import ChameleonForConditionalGeneration, LlamaTokenizerFast
