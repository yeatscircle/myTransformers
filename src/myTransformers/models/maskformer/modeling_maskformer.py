...
@dataclass
# Copied from myTransformers.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from myTransformers.models.detr.modeling_detr.DetrDecoderLayer
...
class MaskFormerModel(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, MaskFormerModel
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoImageProcessor, MaskFormerForInstanceSegmentation
        >>> from PIL import Image
        >>> import requests
