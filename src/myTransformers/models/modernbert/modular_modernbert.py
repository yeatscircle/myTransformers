...
class ModernBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import ModernBertModel, ModernBertConfig
...
class ModernBertMLP(nn.Module):
    ...
    Compared to the default BERT architecture, this block replaces :class:`~myTransformers.model.bert.modeling_bert.BertIntermediate`
    and :class:`~myTransformers.model.bert.modeling_bert.SelfOutput` with a single module that has similar functionality.
    """
