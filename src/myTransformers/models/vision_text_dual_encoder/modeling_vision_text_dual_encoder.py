...
# Copied from myTransformers.models.clip.modeling_clip.clip_loss
...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import VisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from myTransformers import VisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import VisionTextDualEncoderModel
