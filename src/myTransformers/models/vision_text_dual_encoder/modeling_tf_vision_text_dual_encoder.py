...
# Copied from myTransformers.models.clip.modeling_tf_clip.clip_loss
...
class TFVisionTextDualEncoderModel(TFPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import TFVisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from myTransformers import TFVisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import TFVisionTextDualEncoderModel
