...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AlignConfig, AlignModel
    ...
    >>> from myTransformers import AlignTextConfig, AlignVisionConfig
