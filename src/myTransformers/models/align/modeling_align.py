...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.round_filters with EfficientNet->AlignVision
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.correct_pad
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.EfficientNetEmbeddings with EfficientNet->AlignVision
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.EfficientNetDepthwiseConv2d with EfficientNet->AlignVision
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.EfficientNetExpansionLayer with EfficientNet->AlignVision
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.EfficientNetDepthwiseLayer with EfficientNet->AlignVision
...
# Copied from myTransformers.models.efficientnet.modeling_efficientnet.EfficientNetSqueezeExciteLayer with EfficientNet->AlignVision
...
# Copied from myTransformers.models.bert.modeling_bert.BertEmbeddings with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertSelfAttention with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertSelfOutput with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertAttention with Bert->AlignText,BERT->ALIGN_TEXT
...
# Copied from myTransformers.models.bert.modeling_bert.BertIntermediate with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertOutput with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertLayer with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertEncoder with Bert->AlignText
...
# Copied from myTransformers.models.bert.modeling_bert.BertPooler with Bert -> AlignText
...
class AlignTextModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, AlignTextModel
...
class AlignVisionModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, AlignVisionModel
...
class AlignModel(AlignPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, AlignModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from myTransformers import AutoProcessor, AlignModel
