...
# Copied from myTransformers.models.clip.modeling_clip.contrastive_loss with clip->owlvit
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from myTransformers.models.clip.modeling_clip.clip_loss with clip->owlvit
...
# Copied from myTransformers.models.clip.modeling_clip.CLIPMLP with CLIP->OwlViT
...
# Copied from myTransformers.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->OwlViT
...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from myTransformers import AutoProcessor, OwlViTTextModel
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from myTransformers import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from myTransformers import AutoProcessor, OwlViTModel
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from myTransformers import AutoProcessor, OwlViTForObjectDetection
    ...
    def forward(
        ...
        >>> from myTransformers import OwlViTProcessor, OwlViTForObjectDetection
