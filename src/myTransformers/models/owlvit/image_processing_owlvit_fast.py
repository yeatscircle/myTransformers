...
class OwlViTImageProcessorFast(BaseImageProcessorFast):
    ...
    # Copied from myTransformers.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process
    ...
    # Copied from myTransformers.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process_object_detection
