...
# Copied from myTransformers.models.sam.modeling_sam.SamPatchEmbeddings with Sam->SegGpt
...
# Copied from myTransformers.models.sam.modeling_sam.SamMLPBlock with SamMLPBlock->SegGptMlp
...
# Copied from myTransformers.models.beit.modeling_beit.BeitDropPath with Beit->SegGpt
...
# Copied from myTransformers.models.convnext.modeling_convnext.ConvNextLayerNorm with ConvNext->SegGpt
...
class SegGptModel(SegGptPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import SegGptImageProcessor, SegGptModel
...
class SegGptForImageSegmentation(SegGptPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from myTransformers import SegGptImageProcessor, SegGptForImageSegmentation
        >>> from PIL import Image
        >>> import requests
