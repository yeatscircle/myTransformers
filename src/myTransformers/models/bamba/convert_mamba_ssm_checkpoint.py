...
"""This script can be used to convert checkpoints provided in the `mamba_ssm` library into the format provided in HuggingFace `myTransformers`. It depends on the `mamba2_ssm` package to be installed."""
...
from myTransformers.utils import SAFE_WEIGHTS_INDEX_NAME, SAFE_WEIGHTS_NAME
...
# Adapted from myTransformers.models.mamba.convert_mamba_ssm_checkpoint_to_pytorch.py
