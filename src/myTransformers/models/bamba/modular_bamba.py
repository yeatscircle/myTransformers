...
import myTransformers.models.jamba.modeling_jamba as modeling_jamba
from myTransformers.activations import ACT2FN
from myTransformers.models.jamba.modeling_jamba import JambaAttentionDecoderLayer
from myTransformers.models.llama.modeling_llama import (
    LlamaAttention,
    LlamaForCausalLM,
    LlamaMLP,
    LlamaRMSNorm,
...
from myTransformers.models.mamba2.modeling_mamba2 import (
    MambaRMSNormGated,
    pad_tensor_by_size,
    reshape_into_chunks,
    segment_sum,
...
# Adapted from myTransformers.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache for the v2 mixer
...
# Adapted from myTransformers.models.glm.modular_glm.apply_rotary_pos_emb
...
# Adapted from myTransformers.models.mamba2.modeling_mamba2.Mamba2Mixer
...
# Adapted from myTransformers.models.jamba.modeling_jamba.JambaModel
...
class BambaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from myTransformers import AutoTokenizer, BambaForCausalLM
