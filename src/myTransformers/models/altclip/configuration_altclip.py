...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from myTransformers import AltCLIPConfig, AltCLIPModel
