...
class VivitEmbeddings(nn.Module):
    ...
    # Adapted from myTransformers.models.vit.modeling_vit.ViTEmbeddings.interpolate_pos_encoding
...
# Copied from myTransformers.models.vit.modeling_vit.ViTSelfAttention with ViT->Vivit
...
# Copied from myTransformers.models.vit.modeling_vit.ViTSelfOutput with ViT->Vivit
...
# Copied from myTransformers.models.vit.modeling_vit.ViTAttention with ViT->Vivit
...
class VivitModel(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from myTransformers import VivitImageProcessor, VivitModel
...
class VivitForVideoClassification(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from myTransformers import VivitImageProcessor, VivitForVideoClassification
        >>> from huggingface_hub import hf_hub_download
