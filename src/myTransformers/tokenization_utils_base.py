...
class SpecialTokensMixin:
    ...
    def sanitize_special_tokens(self) -> int:
        ...
        myTransformers v5.
        """
        logger.warning_once("The `sanitize_special_tokens` will be removed in myTransformers v5.")
...
def get_fast_tokenizer_file(tokenization_files: List[str]) -> str:
    """
    Get the tokenization file to use for this version of myTransformers.
