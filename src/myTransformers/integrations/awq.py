...
def get_modules_to_fuse(model, quantization_config):
    ...
    Args:
        ...
        quantization_config (`~myTransformers.quantization_config.AWQConfig`):
    ...
    if quantization_config.modules_to_fuse is not None:
        ...
        raise ValueError(
            ...
            " in the `quantization_config` or raise an issue on myTransformers https://github.com/huggingface/transformers to add its support."
        )
