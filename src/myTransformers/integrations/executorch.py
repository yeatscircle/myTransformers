...
if is_torch_available():
    from myTransformers import HybridCache, PreTrainedModel, StaticCache
    from myTransformers.pytorch_utils import is_torch_greater_or_equal, is_torch_greater_or_equal_than_2_3
