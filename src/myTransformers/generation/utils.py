...
from myTransformers.generation.candidate_generator import AssistantVocabTranslatorCache
...
class GenerationMixin:
    ...
    `GenerationConfig` at initialization time or ensuring `generate`-related tests are run in `myTransformers` CI.
    ...
    def compute_transition_scores(
        ...
        ```python
        >>> from myTransformers import GPT2Tokenizer, AutoModelForCausalLM
        >>> import numpy as np
