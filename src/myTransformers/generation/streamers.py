...
class TextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from myTransformers import AutoModelForCausalLM, AutoTokenizer, TextIteratorStreamer
...
class AsyncTextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from myTransformers import AutoModelForCausalLM, AutoTokenizer, AsyncTextIteratorStreamer
        >>> from threading import Thread
        >>> import asyncio
