...
class RepetitionPenaltyLogitsProcessor(LogitsProcessor):
    ...
    ```py
    >>> from myTransformers import AutoTokenizer, AutoModelForCausalLM, RepetitionPenaltyLogitsProcessor
...
class WhisperTimeStampLogitsProcessor(LogitsProcessor):
    ...
    ``` python
    >>> import torch
    >>> from myTransformers import AutoProcessor, WhisperForConditionalGeneration, GenerationConfig
    >>> from datasets import load_dataset
...
class ClassifierFreeGuidanceLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from myTransformers import AutoProcessor, MusicgenForConditionalGeneration
...
class WatermarkLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from myTransformers import AutoTokenizer, AutoModelForCausalLM, WatermarkingConfig
    ...
    >>> from myTransformers import WatermarkDetector
...
class SynthIDTextWatermarkLogitsProcessor(LogitsProcessor):
    ...
    * **Utility Functions:** Provides functions to compute g-values directly, check for context repetition, create
    ...
    Examples:
    ```python
    >>> from myTransformers import AutoModelForCausalLM, AutoTokenizer, SynthIDTextWatermarkingConfig
