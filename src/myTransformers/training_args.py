...
class TrainingArguments:
    ...
    Parameters:
        ...
        neftune_noise_alpha (`Optional[float]`):
            ...
            [original code](https://github.com/neelsjain/NEFTune). Support myTransformers `PreTrainedModel` and also
        ...
        if not is_sagemaker_mp_enabled():
            if not is_accelerate_available():
                raise ImportError(
                    ...
                    f"Please run `pip install myTransformers[torch]` or `pip install 'accelerate>={ACCELERATE_MIN_VERSION}'`"
                )
