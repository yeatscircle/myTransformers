...
class BatchFeature(UserDict):
    ...
    # Copied from myTransformers.tokenization_utils_base.BatchEncoding.keys
    def keys(self):
        return self.data.keys()

    # Copied from myTransformers.tokenization_utils_base.BatchEncoding.values
    def values(self):
        return self.data.values()

    # Copied from myTransformers.tokenization_utils_base.BatchEncoding.items
    def items(self):
