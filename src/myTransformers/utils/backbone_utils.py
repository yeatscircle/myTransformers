...
def verify_out_features_out_indices(
    ...
    if stage_names is None:
        raise ValueError("Stage_names must be set for myTransformers backbones")
...
class BackboneMixin:
    ...
    def _init_timm_backbone(self, config) -> None:
        ...
        # These will diagree with the defaults for the myTransformers models e.g. for resnet50
...
def load_backbone(config):
    ...
    if specified.
    """
    from myTransformers import AutoBackbone, AutoConfig
