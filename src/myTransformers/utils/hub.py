...
def http_user_agent(user_agent: Union[dict, str, None] = None) -> str:
    ...
    """
    ua = f"myTransformers/{__version__}; python/{sys.version.split()[0]}; session_id/{SESSION_ID}"
...
class PushToHubMixin:
    ...
    def push_to_hub(
        ...
        **deprecated_kwargs,
        ...
        ```python
        from myTransformers import {object_class}
...
def send_example_telemetry(example_name, *example_args, framework="pytorch"):
    ...
    send_telemetry(
        topic="examples", library_name="myTransformers", library_version=__version__, user_agent=http_user_agent(data)
    )
...
def create_and_tag_model_card(
    ...
    try:
        ...
        model_description = "This is the model card of a 🤗 myTransformers model that has been pushed on the Hub. This model card has been automatically generated."
        card_data = ModelCardData(tags=[] if tags is None else tags, library_name="myTransformers")
