...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    This function is not supposed to be directly accessed unless you are writing a custom myTransformers module.
    """
...
def get_verbosity() -> int:
    ...
    - 50: `myTransformers.logging.CRITICAL` or `myTransformers.logging.FATAL`
    - 40: `myTransformers.logging.ERROR`
    - 30: `myTransformers.logging.WARNING` or `myTransformers.logging.WARN`
    - 20: `myTransformers.logging.INFO`
    - 10: `myTransformers.logging.DEBUG`
...
def set_verbosity(verbosity: int) -> None:
    ...
    Args:
        verbosity (`int`):
            ...
            - `myTransformers.logging.CRITICAL` or `myTransformers.logging.FATAL`
            - `myTransformers.logging.ERROR`
            - `myTransformers.logging.WARNING` or `myTransformers.logging.WARN`
            - `myTransformers.logging.INFO`
            - `myTransformers.logging.DEBUG`
    """
