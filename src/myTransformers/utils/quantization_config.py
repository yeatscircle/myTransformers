...
class GPTQConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        block_name_to_quantize (`str`, *optional*):
            The myTransformers block name to quantize. If None, we will infer the block name using common patterns (e.g. model.layers)
...
class AwqConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        modules_to_not_convert (`list`, *optional*, default to `None`):
            ...
            Note you cannot quantize directly with myTransformers, please refer to `AutoAWQ` documentation for quantizing HF models.
        exllama_config (`Dict[str, Any]`, *optional*):
