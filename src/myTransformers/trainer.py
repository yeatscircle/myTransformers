...
class Trainer:
    ...
    Important attributes:
        ...
        - **model** -- Always points to the core model. If using a myTransformers model, it will be a [`PreTrainedModel`]
          subclass.
    ...
    def add_callback(self, callback):
        """
        Add a callback to the current list of [`~myTransformers.TrainerCallback`].

        Args:
           callback (`type` or [`~myTransformers.TrainerCallback]`):
               A [`~myTransformers.TrainerCallback`] class or an instance of a [`~myTransformers.TrainerCallback`]. In the
    ...
    def pop_callback(self, callback):
        """
        Remove a callback from the current list of [`~myTransformers.TrainerCallback`] and returns it.
        ...
        Returns:
            [`~myTransformers.TrainerCallback`]: The callback removed, if found.
        """
        return self.callback_handler.pop_callback(callback)

    def remove_callback(self, callback):
        """
        Remove a callback from the current list of [`~myTransformers.TrainerCallback`].
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", dict[str, Any]]):
        ...
        if self.is_deepspeed_enabled:
            ...
            from myTransformers.integrations.deepspeed import HfTrainerDeepSpeedConfig
