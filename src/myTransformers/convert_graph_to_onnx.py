...
from myTransformers.pipelines import Pipeline, pipeline
from myTransformers.tokenization_utils import BatchEncoding
from myTransformers.utils import ModelOutput, is_tf_available, is_torch_available
...
class OnnxConverterArgumentParser(ArgumentParser):
    """
    Wraps all the script arguments supported to export myTransformers models to ONNX IR
    """
...
def convert(
    ...
    **model_kwargs,
    ...
    """
    warnings.warn(
        "The `myTransformers.convert_graph_to_onnx` package is deprecated and will be removed in version 5 of"
        " Transformers",
        FutureWarning,
    )
        ...
        if args.quantize:
            ...
            if args.framework == "tf":
                print(
                    ...
                    "\t\thttps://github.com/microsoft/onnxruntime/tree/master/onnxruntime/python/tools/myTransformers\n"
                )
