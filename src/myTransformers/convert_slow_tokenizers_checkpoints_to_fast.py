...
TOKENIZER_CLASSES = {
    ...
    name: getattr(myTransformers, "LlamaTokenizerFast" if name == "Phi3Tokenizer" else name + "Fast")
...
def convert_slow_checkpoint_to_fast(tokenizer_name, checkpoint_name, dump_path, force_download):
    ...
    if tokenizer_name is None:
        ...
        tokenizer_names = {tokenizer_name: getattr(myTransformers, tokenizer_name + "Fast")}
