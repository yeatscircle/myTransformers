...
>> > from myTransformers import MimiModel, AutoFeatureExtractor
...
>> > inputs = feature_extractor(raw_audio=audio_sample, sampling_rate=feature_extractor.sampling_rate,
                                return_tensors="pt")
