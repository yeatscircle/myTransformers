...
```bash
python src/myTransformers/models/musicgen/convert_musicgen_transformers.py \
...
```python
>> > from myTransformers import AutoConfig, MusicgenForCausalLM, MusicgenForConditionalGeneration
